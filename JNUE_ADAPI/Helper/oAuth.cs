...
namespace JNUE_ADAPI.Helper
{
    ...
    public class oAuth
    {
        ...
        public static async Task<string> GetTokenHelperAsync(AuthenticationContext context, string resourceId)
        {
            ...
            string myKey = Properties.AzClientSecret;
        ...
        public static async Task<string> getLoginToken(string userid, string passwd)
        {
            ...
            vals.Add(new KeyValuePair<string, string>("client_id", Properties.AzClientID));
            vals.Add(new KeyValuePair<string, string>("client_secret", Properties.AzClientSecret));
