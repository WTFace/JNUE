namespace JNUE_ADAPI.AD
{
    ...
    public class LocalAD
    {
        ...
        {
            bool found = false;
            if (DirectoryEntry.Exists(Properties.LDAPPath))
            {
                found = true;
            }
            return found;
        ...
        public static bool ExistAttributeValue(string attributeName, string value)
        {
            ...
            {
                bool exist = false;
                using (DirectoryEntry entry = new DirectoryEntry(Properties.LDAPPath, Properties.LDAPUser, Properties.LDAPPassword, AuthTypes))
                {
        ...
        public static string Authenticate(string userid, string passwd)
        {
            ...
            try
            {
                DirectoryEntry entry = new DirectoryEntry(Properties.LDAPPath, userid, passwd, AuthTypes);
        ...
        public static IEnumerable<User> getLocalUserById(string userid)
        {
            ...
            DirectoryEntry de = new DirectoryEntry(Properties.LDAPPath);
            de.Username = Properties.LDAPUser;
            de.Password = Properties.LDAPPassword;
